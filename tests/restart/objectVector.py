...
if args.restart:
    u = ymr.udevicex(MPI._addressof(comm), ranks, domain, debug_level=8, log_filename='log', checkpoint_every=0)
else:
    u = ymr.udevicex(MPI._addressof(comm), ranks, domain, debug_level=8, log_filename='log', checkpoint_every=5)
