...
plate_lo = udx.Walls.Plane("plate_lo", normal=(0, 0, -1), pointThrough=(0, 0,              args.D))
plate_hi = udx.Walls.Plane("plate_hi", normal=(0, 0,  1), pointThrough=(0, 0,  domain[2] - args.D))
...
# cd walls/volume
# rm -rf volume*txt
# udx.run --runargs "-n 1" ./plates.py --D 1.0 > /dev/null
