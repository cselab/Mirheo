...
dpd = udx.Interactions.DPD('dpd', rc=rc, a=10.0, gamma=50.0, kbt=0.01, dt=dt, power=0.125)
...
# sTEST: walls.analytic.couette
# cd walls/analytic
# rm -rf h5
# udx.run --runargs "-n 2" ./couette.py
# udx.avgh5 xy velocity h5/solvent-0001[4-7].h5 | awk '{print $1}' > profile.out.txt
