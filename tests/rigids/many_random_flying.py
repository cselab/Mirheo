...
ic_ell = ymr.InitialConditions.Rigid(com_q=com_q.tolist(), coords=coords, init_vels=vels.tolist())
...
u.registerPlugins( ymr.Plugins.createDumpObjectStats("objStats", pv_ell, dump_every=10, path="stats") )
u.run(1000)
...
# ymr.run --runargs "-n 2" ./many_random_flying.py --nranks 1 1 1 --nobjects 55  $f
...
# rho=4.0; ax=1.0; ay=2.0; az=3.0
# cp ../../data/ellipsoid_coords_${rho}_${ax}_${ay}_${az}.txt $f
# ymr.run --runargs "-n 12" ./many_random_flying.py --nranks 1 2 3 --nobjects 123  $f
# LC_ALL=en_US.utf8 sort -g -k1 -k2 stats/ellipsoid.txt > freefly.out.txt
