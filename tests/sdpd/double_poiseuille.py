...
den  = mir.Interactions.Density('den', rc, kernel="WendlandC2")
sdpd = mir.Interactions.SDPD('sdpd', rc, viscosity=10.0, kBT=1.0, EOS="Linear", sound_speed=10.0, rho_0=0.0, density_kernel="WendlandC2")
