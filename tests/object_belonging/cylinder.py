...
pv_cyl = ymr.ParticleVectors.RigidCylinderVector('cylinder', mass=1, object_size=len(coords), radius=R, length=L)
ic_cyl = ymr.InitialConditions.Rigid(com_q, coords)
...
inner_checker = ymr.BelongingCheckers.Cylinder("inner_solvent_checker")
