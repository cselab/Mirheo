...
pv_rod = ymr.ParticleVectors.RodVector('rod', mass=1, num_segments = 10)
ic_rod = ymr.InitialConditions.Rod(com_q, center_line, torsion, radius)
...
inner_checker = ymr.BelongingCheckers.Rod("inner_solvent_checker", radius)
