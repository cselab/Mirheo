...
# cd membrane
# cp ../../data/rbc_mesh.off .
# ymr.run --runargs "-n 2" ./rest.py --stress_free
# mv pos.rbc.txt pos.rbc.out.txt 
...
# ymr.run --runargs "-n 2" ./rest.py --stress_free --sphere_stress_free
# mv pos.rbc.txt pos.rbc.out.txt 

# nTEST: membrane.rest.fluctuations
# cd membrane
# cp ../../data/rbc_mesh.off .
# ymr.run --runargs "-n 2" ./rest.py --fluctuations
# mv pos.rbc.txt pos.rbc.out.txt 

# nTEST: membrane.rest.stress_free.fluctuations
# cd membrane
# cp ../../data/rbc_mesh.off .
# ymr.run --runargs "-n 2" ./rest.py --stress_free --fluctuations
# mv pos.rbc.txt pos.rbc.out.txt 
