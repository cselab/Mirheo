...
/*!
 * Read a file in .off format (ASCII) representing a triangle mesh 
 * into vertex coordinates and faces connectivity
 * This method will die if the found is not found or if the 
 * internal structure is not correct.
 */
