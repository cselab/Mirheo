...
namespace external_magnetic_torque_plugin_kernels
{
...
ExternalMagneticTorquePlugin::ExternalMagneticTorquePlugin(const MirState *state, std::string name,
                                                           std::string rovName, real3 moment,
...
void ExternalMagneticTorquePlugin::setup(Simulation *simulation, const MPI_Comm& comm, const MPI_Comm& interComm)
{
...
void ExternalMagneticTorquePlugin::beforeForces(cudaStream_t stream)
{
    ...
    SAFE_KERNEL_LAUNCH(
            external_magnetic_torque_plugin_kernels::applyMagneticField,
